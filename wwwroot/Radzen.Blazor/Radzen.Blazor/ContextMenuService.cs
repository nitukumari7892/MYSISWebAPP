...
namespace Radzen
{
    ...
    public class ContextMenuService : IDisposable
    {
        ...
        public void Open(MouseEventArgs args, IEnumerable<ContextMenuItem> items, Action<ContextMenuItem> click = null)
        {
            var options = new ContextMenuOptions();

            options.Items = items;
            options.ClickNew = click;
    ...
    public class ContextMenuOptions
    {
        ...
        public Action<ContextMenuItem> ClickNew { get; set; }
    }
